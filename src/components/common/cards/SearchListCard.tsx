...
function SearchListCard({ title, description }: SearchListCardProps) {
    return (
        <div className="w-full flex bg-white border border-gray-200 rounded-2xl shadow-sm hover:shadow-md transition overflow-hidden">
            ...
            {/* 우측 영역 */}
            <div className="flex flex-col border-gray-100 p-6 flex items-center">

                <button className="w-[200px] h-[60px] bg-green-700 text-gray-100 px-5 py-2 mb-5 rounded-lg font-medium hover:bg-green-200 transition">
                    일정 보기
                </button>
