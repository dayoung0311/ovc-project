    ...
    <form className="space-y-4" onSubmit={handleSubmit}>
      <div>
        ...
        <select
          ...
          className="w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-gray-900 outline-none transition focus:border-primary"
          onChange={(e) => {
        ...
        <div className="relative">
          ...
          {isNameFocused && keyword.length > 0 && (
            <div className="absolute left-0 top-full z-10 mt-1 w-full rounded-xl border border-gray-200 bg-white p-2 shadow-md">
              {isCertSearching ? (
                <p className="px-2 py-1 text-sm text-gray-500">검색 중...</p>
      ...
      <div className="flex justify-end gap-3 pt-2">
        <button
          type="button"
          onClick={onClose}
          className="rounded-xl border border-gray-200 px-4 py-2 font-medium text-gray-700 transition hover:bg-gray-50"
        >
          취소
        </button>
        ...
        <button
          ...
          className="rounded-xl bg-primary px-4 py-2 font-semibold text-white transition hover:bg-primaryDark disabled:opacity-60"
        >
